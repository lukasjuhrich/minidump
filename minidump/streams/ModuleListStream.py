...
class VS_FIXEDFILEINFO:
    ...
    def parse(buff):
        ...
        vf.dwStrucVersion = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
        vf.dwFileVersionMS = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
        vf.dwFileVersionLS = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
        vf.dwProductVersionMS = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
        vf.dwProductVersionLS = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
        vf.dwFileFlagsMask = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
        ...
        vf.dwFileSubtype = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
...
class MINIDUMP_MODULE:
    ...
    def get_size(self):
        return (
            ...
            + 8
            + 8
            + VS_FIXEDFILEINFO().get_size()
            + 2 * MINIDUMP_LOCATION_DESCRIPTOR().get_size()
        )
    ...
    def parse(buff):
        ...
        mm.TimeDateStamp = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
        mm.ModuleNameRva = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
...
class MINIDUMP_MODULE_LIST:
    ...
    def parse(buff):
        ...
        mml.NumberOfModules = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
