...
class XMM_SAVE_AREA32:
    ...
    def parse(cls, buff):
        ...
        xmm.ErrorSelector = int.from_bytes(
        ...
        xmm.DataSelector = int.from_bytes(
            buff.read(2), byteorder="little", signed=False
        )
...
class CONTEXT:
    ...
    def parse(cls, buff):
        ...
        ctx.P1Home = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.P2Home = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.P3Home = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.P4Home = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.P5Home = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.P6Home = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.ContextFlags = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )  # DWORD
        ctx.MxCsr = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )  # DWORD
        ctx.SegCs = int.from_bytes(
            buff.read(2), byteorder="little", signed=False
        )  # WORD
        ctx.SegDs = int.from_bytes(
            buff.read(2), byteorder="little", signed=False
        )  # WORD
        ctx.SegEs = int.from_bytes(
            buff.read(2), byteorder="little", signed=False
        )  # WORD
        ctx.SegFs = int.from_bytes(
            buff.read(2), byteorder="little", signed=False
        )  # WORD
        ctx.SegGs = int.from_bytes(
            buff.read(2), byteorder="little", signed=False
        )  # WORD
        ctx.SegSs = int.from_bytes(
            buff.read(2), byteorder="little", signed=False
        )  # WORD
        ctx.EFlags = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )  # DWORD
        ctx.Dr0 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Dr1 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Dr2 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Dr3 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Dr6 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Dr7 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Rax = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Rcx = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Rdx = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Rbx = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Rsp = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Rbp = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Rsi = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Rdi = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.R8 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.R9 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.R10 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.R11 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.R12 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.R13 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.R14 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.R15 = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.Rip = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.DUMMYUNIONNAME = CTX_DUMMYUNIONNAME.parse(buff)

        ctx.VectorRegister = M128A.parse_array(buff, 26)  # M128A   [26]
        ctx.VectorControl = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.DebugControl = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.LastBranchToRip = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.LastBranchFromRip = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.LastExceptionToRip = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
        ctx.LastExceptionFromRip = int.from_bytes(
            buff.read(8), byteorder="little", signed=False
        )  # DWORD64
...
class WOW64_FLOATING_SAVE_AREA:
    ...
    def parse(cls, buff):
        ...
        ctx.ErrorSelector = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
        ctx.DataOffset = int.from_bytes(buff.read(4), byteorder="little", signed=False)
        ctx.DataSelector = int.from_bytes(
            buff.read(4), byteorder="little", signed=False
        )
        ctx.RegisterArea = int.from_bytes(
            buff.read(80), byteorder="little", signed=False
        )
