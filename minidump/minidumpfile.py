    ...
    def __parse_header(self):
        ...
        for i in range(0, self.header.NumberOfStreams):
            ...
            if minidump_dir:
                ...
                self.file_handle.seek(self.header.StreamDirectoryRva + i * 12, 0)
                user_stream_type_value = MINIDUMP_DIRECTORY.get_stream_type_value(
                    self.file_handle
                )
                logging.debug(
    ...
    def __parse_directories(self):
        ...
        for dir in self.directories:
            if dir.StreamType == MINIDUMP_STREAM_TYPE.UnusedStream:
                ...
                self.memory_segments_64 = MinidumpMemory64List.parse(
                ...
                self.unloaded_modules = MinidumpUnloadedModuleList.parse(
                    dir, self.file_handle
                )
